  ...
  return (
    <div className="flex sticky top-0 z-0 sm:relative bg-green-900">
      ...
      <div className="flex justify-center items-center pl-2 w-1/5 animate-pulse pr-2 sm:bg-yellow-500">
        <a href="https://www.peddle.com/offer?pub_id=289876"  target="_blank"className="bg-yellow-500 text-sm text-center sm:text-lg font-bold no-underline font-serif text-white border-2 sm:border-none sm:rounded-none p-1"><i className="fas fa-money-bill-alt text-lg text-green-900"></i> INSTANT OFFER</a>
      </div>
    </div>
  );
}
