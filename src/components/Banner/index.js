  ...
  return (
    <div className="flex sticky top-0 z-0 sm:relative w-full">
      <div className="flex justify-center w-100 items-center text-white font-bold sm:text-lg no-underline border-1 bg-red-500 text-center pt-1">
        ...
        <a href="tel:+15183140703" classId="call_btn_banner" className="text-white font-serif no-underline">
      ...
      <div className="flex justify-center items-center p-0 w-100 bg-yellow-500">
        <a href="https://www.peddle.com/offer?pub_id=289876" rel="noreferrer"  target="_blank" classId="instant-offer-link" className="  animate-pulse bg-yellow-500 text-lg text-center sm:text-xl font-bold no-underline font-serif text-white  p-1.5">
