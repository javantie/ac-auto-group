...
function Banner() {
  return (
    <div className="flex sticky top-0 z-0 sm:relative bg-green-900 w-full">
      <div className="flex justify-center w-100 items-center text-white font-bold sm:text-lg no-underline border-1 bg-red-500 text-center">
      ...
      <div className="flex justify-center items-center p-0 w-100 animate-pulse bg-yellow-500">
